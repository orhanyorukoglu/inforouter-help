...
Notice that the user properties window contains many links to describe the selected user. For information on these sidebar items refer to the [User Profile](UserProfile.aspx) help.
...
You may consider transferring the users documents and folders to another infoRouter user before deleting the user. For more information on this topic refer to [Transferring ownership](TransferOwnership.aspx).