...
* http://(machine\_name)/infoRouter
* http://infoRouter
* http://infoRouter.acme.com

If infoRouter was installed as a virtual directory, the (machine\_name) is the name of the server and infoRouter is the default name of the virtual directory.
