...
In addition to membership requirements, library policies also determine a set of rules in which users can perform certain actions. For more on this topic, please navigate to [Library Policies](LibraryPolicies.aspx)

Folder Level Security

The second level of infoRouter security is at the folder level. Access to folders within a library is subject to [Folder Security](FolderSecurity.aspx).

Document Level Security

The third level of infoRouter security is at the document level.

Access to documents within folders is subject to [Document Security](DocumentSecurity.aspx).
