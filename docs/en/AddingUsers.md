...
* First name
* Last name
* E-mail Address (infoRouter uses this information to send e-mail notifications)
* User status (Enabled by default)
* Password
* Confirm Password
* Depending on your application settings you may have to choose between LDAP authentication (NTLM) and infoRouter authentication (see  [User Authentication](Authentication.aspx)).
* Click "Ok".
