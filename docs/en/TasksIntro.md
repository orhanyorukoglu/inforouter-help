# Introduction to infoRouter Tasks
...
Task assignees receive e-mail notifications for every task assigned to them and they can also track their tasks in the [My Tasks](MyTasks.aspx) window.
...
[Task redirection](TaskRedirection.aspx)
